# Generated by Django 5.1.6 on 2025-03-24 23:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, null=True)),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='owned_village', to='api.user')),
                ('residents', models.ManyToManyField(related_name='village_members', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            name='villager',
            fields=[
                ...
                ('associate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='associate_villagers', to='api.user')),
