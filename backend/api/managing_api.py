...
# Sends the json of the villages the user is a part of
...
# Sends json of the village that a specific user is a part of
...
# Adds a villager to the user's village
# and creates a user_support_relation and villager instance
...
# Removes a villager from the user's village
# and deletes the corresponding user_support_relation and villager instances
...
def initialize_village(request):
    ...
    try:
        ...
        description = f"{user.username}'s Village"
